...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  locales: {
    '/': {
      lang: 'zh-CN',
      title: "资料总结",
      description: '个人资料总结，存放笔记',
    }
  },
  base: '/TechnicalSummary/', // 默认'/'。如果你想将你的网站部署到如 https://foo.github.io/bar/，那么 base 应该被设置成 "/bar/",（否则页面将失去样式等文件）
  ...
  themeConfig: {
    ...
    repo: 'wulinghui/TechnicalSummary', // 导航栏右侧生成Github链接
    ...
    author: {
      name: 'wulinghui', // 必需
      link: 'https://gitee.com/hellowllh/projects', // 可选的
    },
      ...
      icons: [
        {
          ...
          title: '发邮件',
          link: 'mailto:873406903@qq.com',
        },
        {
          iconClass: 'icon-github',
          title: 'GitHub(移步到gitee)',
          link: 'https://github.com/wulinghui',
        },
        {
          ...
          iconClass: 'icon-gitee',
          title: 'CSDN',
          link: 'https://blog.csdn.net/qq_41720208',
        },{
          iconClass: 'icon-bokeyuan',
          title: '博客园',
          link: 'https://www.cnblogs.com/wlh1995',
        }
      ],
    },
